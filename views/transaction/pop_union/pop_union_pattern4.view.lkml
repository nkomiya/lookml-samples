...
#}
  ...
  dimension: is_compare_period_one_before {
    ...
    type: yesno
    sql:
      ${order_items.is_for_compare_period_one_before}
      AND ${axis} BETWEEN ${compare_period_one_before_start} AND ${compare_period_one_before_end}
    ;;
  }
  ...
  dimension: is_compare_period_two_before {
    ...
    type: yesno
    sql:
      ${order_items.is_for_compare_period_two_before}
      AND ${axis} BETWEEN ${compare_period_two_before_start} AND ${compare_period_two_before_end}
    ;;
  }
